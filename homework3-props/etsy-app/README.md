...
![Список предложений](./assets/preview-listing.png)
...
Задание Список предложений сделано совместно с заданием Рейтинг фильмов. Компонент `Stars` добавлен в компонент `ListingItem`.
